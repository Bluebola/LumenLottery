...
export default function PeerPressureGame({ onBrightnessChange, onExit }: MinigameProps) {
  return (
    <View style={styles.container}>
      <Text style={styles.emoji}>😰</Text>
      <Text style={styles.title}>Peer Pressure Slider</Text>
      <Text style={styles.placeholder}>Coming Soon!</Text>
      <Text style={styles.hint}>"Are you SURE you want it brighter?"{'\n'}Shame text for extreme settings</Text>
    </View>
  );
}
